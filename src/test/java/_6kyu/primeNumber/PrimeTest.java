...
public class PrimeTest {
        ...
        @Test
        public void testReallyLongNumber() {
            assertTrue("58139687 is not prime", Prime.isPrime(58139687));
            assertFalse("1755763234 is not prime", Prime.isPrime(1755763234));
            assertTrue("366091709 is not prime", Prime.isPrime(366091709));
            assertTrue("622829149 is not prime", Prime.isPrime(622829149));
            assertTrue("1613092961 is not prime", Prime.isPrime(1613092961));
            assertFalse("146970711 is not prime", Prime.isPrime(146970711));
            assertTrue("1362600209 is not prime", Prime.isPrime(1362600209));
            assertTrue("1605162719 is not prime", Prime.isPrime(1605162719));
            assertTrue("1605162719 is not prime", Prime.isPrime(1605162719));
            assertTrue("1605162719 is not prime", Prime.isPrime(1605162719));
